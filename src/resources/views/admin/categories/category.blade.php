...
@section('admin-content')
	...
	<form action="{{Request::segment(1)}}/categories/save/{{$category->id or 'new'}}" method="post" enctype="multipart/form-data">
		...
		@if ($category->id)
			<a class="button remove-item" href="{{Request::segment(1)}}/categories/delete/{{$category->id}}">Delete</a>
		@endif
	</form>
