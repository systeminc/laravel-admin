...
@section('admin-content')
	...
	<section>	
		...
		<form action="{{Request::segment(1)}}/products/save/{{$product->id or 'new'}}" method="post" enctype="multipart/form-data">
			...
			@if ($product->id)
				<a class="button remove-item" href="{{Request::segment(1)}}/products/delete/{{$product->id}}">Delete</a>
			@endif
