...
class CategoriesController extends Controller
{
    ...
    public function postSave(Request $request)
    {
        ...
        return redirect($request->segment(1).'/categories/edit/'.$category->id)->with('success', 'Saved successfully');
    }
    ...
    public function getDelete(Request $request, $id)
    {
        ...
        return redirect($request->segment(1).'/categories/')->with('success', 'Item deleted');
    }
}
