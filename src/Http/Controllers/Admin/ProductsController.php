...
class ProductsController extends Controller
{
    ...
    public function getNew(Request $request)
    {
        ...
        return redirect($request->segment(1).'/products/edit/'.$product->id);
    }
    ...
    public function postSave(Request $request)
    {
        ...
        return redirect($request->segment(1).'/products/edit/'.$product->id)->with('success', 'Saved successfully');
    }
    ...
    public function getDelete(Request $request, $id)
    {
        ...
        return redirect($request->segment(1).'/products/')->with('success', 'Item deleted');
    }
}
