...
class LeadsController extends Controller
{
    ...
    {
        if (config('laravel-admin.modules.leads') == false) {
            return redirect(config('laravel-admin.route_prefix'))->with('error', 'Leads module is disabled in config/laravel-admin.php')->send();
        }
    }
