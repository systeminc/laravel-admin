...
mix.setPublicPath('resources/assets/dist/');
    ...
    mix.less('resources/assets/src/less/login.less', '../dist/css/admin.css')
        .less('resources/assets/src/bower_components/jquery-ui/themes/base/jquery-ui.css', '../dist/css/admin.css')
