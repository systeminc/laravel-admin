...
class ModelsTest extends LaravelAdminTestCase
{
    ...
    public function testFillablefieldsProductCategoryModel()
    {
        ...
        $this->assertArraySubset(['title', 'subtitle', 'thumb', 'thumb_hover', 'image', 'image_hover', 'excerpt', 'description', 'menu_order', 'slug', 'seo_title', 'seo_description', 'seo_keywords'], $product_category->getFillable());
    }
