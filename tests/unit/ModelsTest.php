...
class ModelsTest extends LaravelAdminTestCase
{
    ...
    public function testFillablefieldsOrderModel()
    {
        ...
        $this->assertArraySubset(['invoice_number', 'order_status_id', 'shipment_price', 'total_price', 'valid_until', 'date_of_purchase', 'currency', 'note', 'billing_name', 'billing_email', 'billing_telephone', 'billing_address', 'billing_city', 'billing_country', 'billing_postcode', 'billing_contact_person', 'shipping_name', 'shipping_email', 'shipping_telephone', 'shipping_address', 'shipping_city', 'shipping_country', 'shipping_postcode', 'shipping_contact_person', 'parity', 'term_of_payment', 'footnote', 'show_shipping_address'], $order->getFillable());
    }
    ...
    public function testFillablefieldsProductModel()
    {
        ...
        $this->assertArraySubset(['product_category_id', 'brand_id', 'title', 'slug', 'excerpt', 'description', 'long_description', 'thumb', 'image', 'animation', 'video', 'pdf', 'gallery_id', 'price', 'shipment_price', 'menu_order', 'visible', 'featured', 'stock', 'sku', 'seo_title', 'seo_description', 'seo_keywords', 'max_quantity', 'thumb_hover', 'image_hover', 'order_number', 'length', 'width', 'height', 'weight'], $product->getFillable());
    }
    ...
    public function testFillablefieldsProductCategoryModel()
    {
        ...
        $this->assertArraySubset(['title', 'subtitle', 'thumb', 'thumb_hover', 'image', 'image_hover', 'excerpt', 'description', 'order_number', 'slug', 'seo_title', 'seo_description', 'seo_keywords'], $product_category->getFillable());
    }
