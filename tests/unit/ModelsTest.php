...
class ModelsTest extends LaravelAdminTestCase
{
    ...
    public function testFillablefieldsProductModel()
    {
        ...
        $this->assertArraySubset(['product_category_id', 'brand_id', 'title', 'slug', 'excerpt', 'description', 'long_description', 'thumb', 'image', 'animation', 'video', 'pdf', 'gallery_id', 'price', 'shipment_price', 'menu_order', 'visible', 'featured', 'stock', 'sku', 'seo_title', 'seo_description', 'seo_keywords', 'max_quantity', 'thumb_hover', 'image_hover', 'order_number'], $product->getFillable());
    }
